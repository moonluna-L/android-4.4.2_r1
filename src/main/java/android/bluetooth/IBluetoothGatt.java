...
boolean _arg1;
_arg1 = (0!=data.readInt());
this.clientListen(_arg0, _arg1);
reply.writeNoException();
return true;
}
case TRANSACTION_setAdvData:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
this.setAdvData(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
reply.writeNoException();
return true;
}
...
this.beginServiceDeclaration(_arg0, _arg1, _arg2, _arg3, _arg4);
reply.writeNoException();
return true;
}
...
@Override public void clientListen(int clientIf, boolean start) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_clientListen, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void setAdvData(int clientIf, boolean setScanRsp, boolean inclName, boolean inclTxPower, int minInterval, int maxInterval, int appearance, byte[] manufacturerData) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setAdvData, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void beginServiceDeclaration(int serverIf, int srvcType, int srvcInstanceId, int minHandles, android.os.ParcelUuid srvcId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_clientListen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setAdvData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
...
static final int TRANSACTION_registerServer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_unregisterServer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_serverConnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_serverDisconnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_beginServiceDeclaration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_addIncludedService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_addCharacteristic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_addDescriptor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_endServiceDeclaration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_removeService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_clearServices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_sendResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_sendNotification = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
}
...
public void clientListen(int clientIf, boolean start) throws android.os.RemoteException;
public void setAdvData(int clientIf, boolean setScanRsp, boolean inclName, boolean inclTxPower, int minInterval, int maxInterval, int appearance, byte[] manufacturerData) throws android.os.RemoteException;
...
public void beginServiceDeclaration(int serverIf, int srvcType, int srvcInstanceId, int minHandles, android.os.ParcelUuid srvcId) throws android.os.RemoteException;
