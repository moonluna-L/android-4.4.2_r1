...
int _arg1;
_arg1 = data.readInt();
this.clearDnsInterfaceForUidRange(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
/**
    ...
    */
@Override public void clearDnsInterfaceForUidRange(int uid_start, int uid_end) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
    * Clear a user range from being associated with an interface.
    */
public void clearDnsInterfaceForUidRange(int uid_start, int uid_end) throws android.os.RemoteException;
/**
    * Clear the mappings from pid to Dns interface and from uid range to Dns interface.
    */
