...
static final int TRANSACTION_isLocalOrRemoteMusicActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_adjustLocalOrRemoteStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_adjustSuggestedStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_adjustStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_adjustMasterVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_setStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setRemoteStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setMasterVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setStreamSolo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setStreamMute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_isStreamMute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setMasterMute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_isMasterMute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_getMasterVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getStreamMaxVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getMasterMaxVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getLastAudibleStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getLastAudibleMasterVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setRingerMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getRingerMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setVibrateSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getVibrateSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_shouldVibrate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_setMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_playSoundEffect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_playSoundEffectVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_loadSoundEffects = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_unloadSoundEffects = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_reloadAudioSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_avrcpSupportsAbsoluteVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
...
static final int TRANSACTION_getCurrentAudioFocus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_dispatchMediaKeyEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_dispatchMediaKeyEventUnderWakelock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_registerMediaButtonIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_unregisterMediaButtonIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_registerMediaButtonEventReceiverForCalls = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_unregisterMediaButtonEventReceiverForCalls = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_registerRemoteControlDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_registerRemoteController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
...
static final int TRANSACTION_remoteControlDisplayWantsPlaybackPositionSync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_setRemoteControlClientPlaybackPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_updateRemoteControlClientMetadata = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_registerRemoteControlClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_unregisterRemoteControlClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_setPlaybackInfoForRcc = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_setPlaybackStateForRcc = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_getRemoteStreamMaxVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_getRemoteStreamVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_registerRemoteVolumeObserverForRcc = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_startBluetoothSco = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_stopBluetoothSco = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_forceVolumeControlStream = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_setRingtonePlayer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_getRingtonePlayer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_getMasterStreamType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_setWiredDeviceConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_setBluetoothA2dpDeviceConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_startWatchingRoutes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_isCameraSoundForced = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
}
