...
{
data.enforceInterface(DESCRIPTOR);
com.android.emailcommon.provider.Account _arg0;
if ((0!=data.readInt())) {
_arg0 = com.android.emailcommon.provider.Account.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
case TRANSACTION_serviceUpdated:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.serviceUpdated(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public void startSync(long mailboxId, boolean userRequest, int deltaMessageCount) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
_data.writeInt(deltaMessageCount);
...
@Override public void loadAttachment(com.android.emailcommon.service.IEmailServiceCallback cb, long attachmentId, boolean background) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public int getCapabilities(com.android.emailcommon.provider.Account acct) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public void serviceUpdated(java.lang.String emailAddress) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(emailAddress);
mRemote.transact(Stub.TRANSACTION_serviceUpdated, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_hostChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_autoDiscover = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_sendMeetingResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_deleteAccountPIMData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getApiLevel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_searchMessages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_sendMail = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getCapabilities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_serviceUpdated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
}
public android.os.Bundle validate(com.android.emailcommon.provider.HostAuth hostauth) throws android.os.RemoteException;
public void startSync(long mailboxId, boolean userRequest, int deltaMessageCount) throws android.os.RemoteException;
...
public void loadAttachment(com.android.emailcommon.service.IEmailServiceCallback cb, long attachmentId, boolean background) throws android.os.RemoteException;
...
public int getCapabilities(com.android.emailcommon.provider.Account acct) throws android.os.RemoteException;
public void serviceUpdated(java.lang.String emailAddress) throws android.os.RemoteException;
}
